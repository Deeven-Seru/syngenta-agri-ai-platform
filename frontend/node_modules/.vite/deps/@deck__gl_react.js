...
import { $ as Vector3, A as pixelsToWorld, D as altitudeToFovy, E as MAX_LATITUDE, F as memoize, G as Buffer, H as geometry_default, K as log, L as EVENT_HANDLERS, N as project_default, O as fovyToAltitude, P as getShaderCoordinateSystem, Q as transformMat4, R as PROJECTION_MODE, S as typed_array_manager_default, T as getFlyToDuration, U as Texture, V as EventManager, W as Device, X as Matrix4, Z as scale, _t as isBrowser$1, at as negate, b as Viewport, c as DEFAULT_SPECTOR_PROPS, ct as lerp$1, d as Transition, dt as debug, et as len, f as deepEqual, ft as register, gt as Stats, ht as registerLoaders, it as add, j as worldToLngLat, k as lngLatToWorld$1, l as loadSpectorJS, m as LIFECYCLE, mt as load, nt as sqrLen, ot as clamp$4, p as flatten, pt as defaultLogger, q as lumaStats, rt as sub, s as loadWebGLDeveloperTools, st as equals, t as Layer, tt as lerp, u as assert$1, ut as ShaderAssembler, vt as isBrowser, w as flyToViewport, x as mod, y as WebMercatorViewport, yt as assert, z as RECOGNIZERS } from "./layer-BjZjXT_4.js";
...
var WebGLAdapter = class extends Adapter {
	...
	*/
	async attach(gl, props = {}) {
		const { WebGLDevice } = await import("./layer-BjZjXT_4.js").then((n) => n.o);
